...
const textStyles = 'font-theme-font text-sm text-color-primary';
            ...
            return (
                <>
                    ...
                    >
                        <header>
                            ...
                            <div className="flex justify-end bg-color-secondary py-5 pr-10">
                                <Dropdown inline={true} label="Site Theme">
                                    ...
                                    <Dropdown.Item>
                                        <button onClick={() => setTheme(themes.cherry)}>
                                            Cherry
                                        </button>
                                    </Dropdown.Item>
                                    <Dropdown.Item>
                                        <button onClick={() => setTheme(themes.pulse)}>
                                            Pulse
                                        </button>
                                    </Dropdown.Item>
                                </Dropdown>
                        ...
                        <p className="ml-10">
                            My technical skills come from both a computer science degree and
                            years of real world software development experience. I also fancy
                        ...
                        <div className="border-t py-8 text-center text-sm text-color-text bg-color-background">
