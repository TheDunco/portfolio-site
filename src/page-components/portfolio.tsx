...
const Parenthetical: React.FC<ParenProps> = ({ text, className }) => {
    return (
        <>
            ...
            <span
                className={cn(
                    "text-sm font-light text-color-secondary",
                    className
                )}
            >
                ({text})
    ...
    return (
        <>
            ...
            >
                ...
                <p className="ml-10">
                    My technical and other skills come from both a computer
                    science degree and years of real world software development
                    experience. I also fancy a custom project like this one
                    occasionally.
                </p>
                <CustomTimeline className="md:text-lg lg:text-2xl">
                    <CTimelineEntry>
                        ...
                        <CTimelineBody>
                            Took many shop classes, engineering classes, and had
                            my first exposure to Python. Played in band for 4
                            years.
                            <svg
                    ...
                    <CTimelineEntry>
                        ...
                        <CTimelineBody>
                            No code here, but I learned the art of detailing,
                            how to work with a variety of diverse coworkers, and
                            other essential life skills. I cleaned hundreds of
                            RVs inside and out, new and old.
                        </CTimelineBody>
                    </CTimelineEntry>
                    <CTimelineEntry>
                        ...
                        <CTimelineBody>
                            College is where I mainly learned to code, how to
                            play D&D, and I made many new friends along the way,
                            including my fiance!
                                    ...
                                    <div className="flex h-full flex-col items-start justify-start bg-color-bg text-color-text">
                                        <div className="ml-10 mt-5">
                                            ...
                                            <ol className="ml-10 list-disc">
                                                ...
                                                <li>
                                                    Helped start the Calvin Mars
                                                    Rover Design Team as the
                                        ...
                                        <div className="ml-10 mt-5">
                                            ...
                                            <ol className="m-0 ml-10 mb-0 list-disc">
                                                ...
                                                <li>
                                                    ...
                                                    <Parenthetical
                                                        text={
                                                            "Java, Ruby, Clojure, Ada"
                                                        }
                                                    />
                                                </li>
                                                <li>
                                                    Continued as co-lead of
                                                    CMRDT programming team.
                                                </li>
                                            </ol>
                                        </div>
                                    </div>
                    ...
                    <CTimelineEntry>
                        <CTimelineHeader>
                            <span className="mr-2 text-lg">💾</span> Watershed
                            Technologies LLC
                        </CTimelineHeader>
                        <CTimelineTime>
                            2020-2022
                        ...
                        <CTimelineBody>
                            <ol className="list-disc">
                                Worked under an Embedded Systems Engineering
                                contractor (my soon-to-be father in law) to
                                build embedded systems for a variety of real
                                world customers.
                                <li className="ml-10">
                                    Developed many front-end C# applications for
                                    desktop and mobile using Windows and Xamarin
                                    Forms respectively. Interfaced with custom
                                    hardware running C++ using a custom
                                    communication protocol.
                                </li>
                                <li className="ml-10">
                                    These applications included many methods of
                                    user interaction and data-visualization.
                                </li>
                                <li className="ml-10">
                                    Worked on a summer project to build an FPV
                                    (First Person View) RC airplane capable of
                                    autonomous flight via Ardupilot and a
                    ...
                    <CTimelineEntry>
                        ...
                        <CTimelineBody>
                            Full stack Ecommerce software developer utilizing a
                            modern tech stack to build and maintain a production
                            website for a local business, delivering thousands
                            of hand tools to a loyal base of customers.
                        </CTimelineBody>
                    </CTimelineEntry>
                </CustomTimeline>
                <div>
